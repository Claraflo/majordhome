...
<!-- 
		...
		<h5 class="titleMessage"> Re : <?php echo $data['titre'];?></h5>

		<form method="POST" action="createMessage.php">

	    <div class="form-group">
            <textarea class="form-control" name="message" rows="5" cols="30" required="required"></textarea>
        </div>

        </form>
        <button class="btn btn-primary">Envoyez <i class="fas fa-paper-plane"></i></button>
