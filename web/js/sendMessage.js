...
req.open('GET', '../pages/displaySendMessage.php');
req.send();

}
var x = setInterval('displaySendMessage()',5000);
...
req.open('GET', '../pages/deleteMessage.php?id=' + id);
req.send();
...
req.open('GET', '../pages/archiveMessage.php?id=' + id);
req.send();
...
req.open('GET', '../pages/viewSendMessage.php?id=' + id);
req.send();
...
function deleteAllArchiveMessage(){
    ...
    req.open('GET', '../pages/deleteAllArchiveMessage.php?array=' + array);
    req.send();
