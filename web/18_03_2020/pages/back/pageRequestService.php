...
<div>
	<a class="mr-2" href="requestAccepted.php">Demandes acceptées</a>
	<a href="requestRefused.php">Demandes refusées</a>
</div>

<h5 class="pt-2">Demandes en cours</h5>
<hr>
<div>
		...
		foreach ($data as $value) {
			...
			echo '<tr id="\'' . $value["idSouscriptionService"] . '\'" >';
				...
				echo '<td>
						...
						<button onclick="acceptRequest(\'' . $value["idSouscriptionService"] . '\')" class="btn btn-success"><i class="fas fa-check-circle"></i></button>
						<button onclick="refuseRequest(\'' . $value["idSouscriptionService"] . '\')" class="btn btn-danger"><i class="fas fa-times-circle"></i></button>
					</td>';
